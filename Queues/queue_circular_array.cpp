...
public:
    ...
    void enqueue(int element) {
        ...
        arr[rear] = element; 
        // Update the rear index using modulo operation to wrap around the array
    ...
    int dequeue() {
        ...
        // Update the front index using modulo operation to wrap around the array
    ...
    void printQueue() {
        ...
        cout << "Queue elements: "; 
        // Loop through the queue from the front to the rear
        for (int i = front; i < front + size; i++) { 
            // Print each element, wrapping around the array using modulo operation
            cout << arr[i % capacity] << " "; 
        }
